...
<button className='btn btn-primary p-3 ms-2' onClick={()=>dispatch(reset())} style={{width:"110px"}}>Reset</button>

</div>


<div><input type="number" className='form-control w-100 mt-5' placeholder='Please Enter The Range' style={{border:"blue"}}
